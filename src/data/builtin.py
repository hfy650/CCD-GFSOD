...
# -------- COCO -------- #
def register_all_coco(root="/data/nvme0n1/grade1/students/huangfuyi/code/DeFRCN-main/datasets"):
...
# -------- PASCAL VOC -------- #
def register_all_voc(root="/data/nvme0n1/grade1/students/huangfuyi/code/DeFRCN-main/datasets"):
