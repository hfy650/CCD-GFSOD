...
def load_filtered_voc_instances(
    ...
    if is_shots:
        fileids = {}
        split_dir = os.path.join("/data/nvme0n1/grade1/students/huangfuyi/code/DeFRCN-main/datasets", "vocsplit")
    ...
    if is_shots:
        for cls, fileids_ in fileids.items():
            ...
            for fileid in fileids_:
                ...
                dirname = os.path.join("/data/nvme0n1/grade1/students/huangfuyi/code/DeFRCN-main/datasets", "VOC{}".format(year))
